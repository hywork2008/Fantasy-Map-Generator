...
5. Slow-fertility long-lived folk still cannot survive endless total war — limited wars and frontiers matter — but **coexistence is usually “next door,” not “same crown.”**
...
- **Dark elf**: intrigue and isolation; not open ally, not pure monster.
- **Giant / Draconic**: power and pride; keep lesser folk at arm’s length.
...
| Piece | Status |
| :--- | :--- |
| `raceCivicStance` | diplomatic / distant / enemy_colony keys |
...
> *Peoples mostly keep to their own lands. Humans, elves, and dwarves still deal with each other as rivals and allies; giants, dragons, dark elves, and Amazones keep their distance; orcs, goblins, and spider-kin hold colonies and nests you do not invite to court.*
