...
| 項目 | 内容 |
| :--- | :--- |
| Status | Phase 0–2 implemented (2026-08-18). Phase 3 in progress: `japan`, `britain`, `mediterranean-sea`, `europe-central`, and `atlantics` Earth regions added. caribbean 等は未着手。PNG 経路は他 id とユーザー投入用に残存 |
| Parent | なし |
...
- caribbean、iceland など、範囲が狭く検証しやすい id から `EarthRegion` 化する。
