...
| ステップ2: 荷役・集積 | 実装済み | `loading`、O/D マージ、target 55% / min 20%、maxWait 陸14・海10・短海2、定期出港日 1/10/20、export staging・運転資金は [merchant-logistics-warehouses.md](merchant-logistics-warehouses.md)。 |
