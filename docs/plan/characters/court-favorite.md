...
| `tyrant_king` | 君主。Compassion ≤20、Honor ≤45、かつ（Vengefulness ≥75 かつ Boldness ≥45 かつ（Boldness ≥60 または Confidence ≥60））または（Honor ≤30 かつ Greed ≥70 かつ（Vengefulness ≥50 または Boldness ≥50））または（Boldness ≥70 かつ Confidence ≥70 かつ Vengefulness ≥55）。Guile は使わない | 暴君 | the Tyrant |
