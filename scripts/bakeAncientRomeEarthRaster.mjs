#!/usr/bin/env node
/**
 * Bake the Ancient Rome EarthRegion raster: Natural Earth land covering
 * the Roman Empire at AD 117 (Britain to the Caspian, Thebes to Scotland),
 * plus GMTED/ETOPO elevation.
 *
 * Usage: node scripts/bakeAncientRomeEarthRaster.mjs
 */
...
const TILE_DIR = "/tmp/terrarium-ancient-rome";
const NE_PATHS = [
...
async function main() {
  ...
  const dest = path.join(OUT_DIR, "ancient-rome.bin");
