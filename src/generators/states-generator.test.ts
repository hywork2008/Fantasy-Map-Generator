...
describe("States.expandStates", () => {
  it("connects separate settlement nuclei with a minimal administrative corridor", () => {
    ...
    // proves that only the required connecting cell, not a broad flood-fill,
    // becomes governed territory.
