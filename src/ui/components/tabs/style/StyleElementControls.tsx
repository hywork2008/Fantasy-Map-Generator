...
export function StyleElementControls() {
    ...
    <table id="styleElements">
      ...
      <tbody id="styleOcean" style={{ display: visibility.styleOcean ? "block" : "none" }}>
        ...
        <tr data-tip="Define the coast outline contours scheme">
          <td>Ocean layers</td>
          <td>
            <select id="outlineLayers" value={str("outlineLayers")} onChange={e => applyOutlineLayers(e.target.value)}>
      ...
      <tbody id="styleStates" style={{ display: visibility.styleStates ? "block" : "none" }}>
        ...
        <tr style={{ marginTop: "0.8em" }}>
          <td style={{ fontStyle: "italic" }}>Halo is only rendered if "Rendering" option is set to "Best quality"!</td>
        </tr>
