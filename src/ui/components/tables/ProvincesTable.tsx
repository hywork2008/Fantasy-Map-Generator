              ...
              {showExtraColumns && (
                <>
                  <SortableHeader
                    ...
                    sortOrder={sortOrder}
                    onSort={onSort}
                    tip="Click to sort by province form name"
                  />
                  <SortableHeader
                    field="capital"
                    label="Capital"
                    ...
                    sortOrder={sortOrder}
                    onSort={onSort}
                    tip="Click to sort by province capital"
                  />
                </>
              )}
              {!hideStateColumn && (
                <SortableHeader
                  ...
                  sortOrder={sortOrder}
                  onSort={onSort}
                  tip="Click to sort by province owner"
                />
              )}
              {showExtraColumns && (
                <>
                  <SortableHeader
                    ...
                    onSort={onSort}
                    numeric
                    tip="Click to sort by province burgs count"
                  />
                  <SortableHeader
                    field="area"
                    label="Area"
                    ...
                    onSort={onSort}
                    numeric
                    tip="Click to sort by province area"
                  />
                  <SortableHeader
                    field="population"
                    label="Population"
                    ...
                    onSort={onSort}
                    numeric
                    tip="Click to sort by province population"
                  />
                </>
              )}
