  ...
  return (
    <Dialog isOpen={isOpen} title="States Editor" onClose={() => closeDialog("statesEditor")}>
      ...
      >
        ...
        <div data-tip="Click to sort by state area" className="sortable hide icon-sort-number-down" data-sortby="area">
          Area&nbsp;
        </div>
      ...
      <div id="statesFooter" className="totalLine">
      ...
      <div id="statesBottom">
        ...
        <button
          ...
          className="icon-plus"
        />
        <button type="button" id="statesMerge" data-tip="Merge several states into one" className="icon-layer-group" />
        <button
          type="button"
          id="statesExport"
