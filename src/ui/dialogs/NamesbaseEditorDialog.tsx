...
export const NamesbaseEditorDialog: React.FC = () => {
  const isOpen = useDialogState(state => state.openDialogs.has("namesbaseEditor"));

  return (
    <Dialog isOpen={isOpen} title="Namesbase Editor" onClose={() => closeDialog("namesbaseEditor")}>
