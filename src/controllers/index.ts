...
import { initMarkersOverview } from "./markers-overview";
import { initRegimentsOverview } from "./regiments-overview";
...
export function initControllers(
  ...
  initMarkersOverview(worldContext, viewContext, appServices);
  initMilitaryOverview(worldContext, viewContext, appServices);
  initOptions(worldContext, viewContext, appServices);
  initRegimentsOverview(worldContext, viewContext, appServices);
