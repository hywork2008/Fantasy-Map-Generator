...
const burgEditorInternal = {
  ...
  updateBurgValues(): void {
    ...
    getBurgEditorState().setBurgData({
      ...
      cellGrainProduction: economySummary?.cellGrainProduction ?? "—",
      marketGrainProduction: economySummary?.marketGrainProduction ?? "—",
      marketFoodImports: economySummary?.marketFoodImports ?? "—",
      marketFoodReserveGap: economySummary?.marketFoodReserveGap ?? "—",
      ...
      employmentComposition: economySummary?.employmentComposition ?? "—",
      laborResidual: economySummary?.laborResidual ?? "—",
