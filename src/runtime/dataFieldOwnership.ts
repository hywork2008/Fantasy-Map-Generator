...
export const DATA_FIELD_OWNERSHIP: readonly DataFieldOwnership[] = [
  ...
  map("pack.dungeons", "map.annotations", "dungeon.id", ["cell.id", "marker.id"], "cascade"),
  map("pack.cultures", "map.politics", "culture.id", ["cell.id", "race.id"], "reassign"),
  map("pack.races", "map.politics", "race.id", [], "reassign"),
  ...
  simulation("simulation.wilderness", "simulation.cells", "cell.id", ["cell.id", "state.id"]),
  ...
  extension("simulation.extensions.economy.metallurgAssetLedgers", "economy"),
  extension("simulation.extensions.economy.metallurgWorkOrders", "economy"),
  extension("simulation.extensions.economy.metallurgMaterialForecasts", "economy"),
  extension("simulation.extensions.economy.nextMetallurgWorkOrderId", "economy"),
  extension("simulation.extensions.economy.strategicLaborMarkets", "economy", "market.id"),
  extension("simulation.extensions.economy.mineralGeologicalProvinces", "economy", "geological-province.id"),
  extension("simulation.extensions.economy.mineralDistricts", "economy", "mineral-district.id"),
  ...
  extension("simulation.extensions.economy.smelterOperations", "economy", "smelter-operation.id"),
  ...
  extension("simulation.extensions.economy.tradeSecurityLedgers", "economy", "state.id"),
  extension("simulation.extensions.economy.innFacilities", "economy", "burg.id"),
  extension("simulation.extensions.economy.urbanWaterSystems", "economy", "burg.id"),
