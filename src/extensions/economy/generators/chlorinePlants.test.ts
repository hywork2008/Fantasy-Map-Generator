...
import { CHLORINE_PLANT_BUDGET, FACILITY_MAINTENANCE_RATE } from "./chemMedCommon";
...
describe("ChlorinePlantsModule", () => {
  ...
  it("creates a plant, debits the budget, and consumes Salt/Sulfuric Acid/Coal/Firebrick once known", () => {
    ...
    expect(worldContext.pack.states[1].treasury).toBe(
      100 - CHLORINE_PLANT_BUDGET - rn(CHLORINE_PLANT_BUDGET * FACILITY_MAINTENANCE_RATE, 2)
    );
