...
import {
  getGasPowerStations,
  getGasPowerStationsLastSettledYear,
  getSimulationYear,
  getWorldContext,
  setGasPowerStations,
  setGasPowerStationsLastSettledYear
} from "../economyContext";
import {
  consumeNamed,
  debitTreasury,
...
export class GasPowerStationsModule {
  settleAnnual(): boolean {
    ...
    if (getGasPowerStationsLastSettledYear() === year) return false;
    setGasPowerStationsLastSettledYear(year);
