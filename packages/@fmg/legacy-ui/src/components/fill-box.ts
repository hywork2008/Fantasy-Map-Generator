...

{
  ...
  class FillBox extends HTMLElement {
    ...
    connectedCallback() {
      this.addEventListener("mousemove", (this.constructor as typeof FillBox).showTip);
    }

    disconnectedCallback() {
      this.removeEventListener("mousemove", (this.constructor as typeof FillBox).showTip);
    }
