...
export function showUploadMessage(type: string, mapData: any[], mapVersion: string): void {
  ...
  if (type === "invalid") {
    ...
    const archive = (link as any)("https://github.com/Azgaar/Fantasy-Map-Generator/wiki/Changelog", "archived version");
