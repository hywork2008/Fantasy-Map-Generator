...
declare let editBiomes: () => any;
declare let editStates: () => any;
declare let editProvinces: () => any;
declare let editDiplomacy: () => any;
...
declare let toggleBorders: () => any;
declare let drawProvinces: () => any;
declare let toggleProvinces: () => any;
declare let drawEmblems: () => any;
declare let toggleEmblems: () => any;
...
declare let d3: any;
declare let unfog: () => any;
declare let ensureEl: (id: string) => HTMLElement;
declare let generateSeed: () => number;
declare let aleaPRNG: (seed: number) => (() => number);
...
declare let findCell: (x: number, y: number) => number;
declare let getNextId: (type: string) => string;
declare let labelGroupSelect: any;
declare let labels: any;
declare let defs: any;
...
toolsContent.addEventListener("click", function (event) {
  ...
  if (!["BUTTON", "I"].includes((event.target as HTMLElement).tagName)) return;
  ...
  if (event.target.parentNode.id === "regenerateFeature") {
    ...
    $("#alert").dialog({
      ...
      close: function () {
        const box = this.parentElement.querySelector(".checkbox") as HTMLInputElement;
